    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          ...
          <p>
            ...
            convenience, We're dedicated to providing a seamless shopping
      ...
      <div className="flex flex-col md:flex-row text-sm mb-20 gap-1">
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          ...
          <p className="text-gray-600">We meticulously select and vet each product ot ensure it meets our stringent quality standards.</p>
        </div>
        <div className="border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5">
          <b>Convenience:</b>
